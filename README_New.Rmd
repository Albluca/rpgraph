...
The package will provide functions that can be used to study biological processes with principal graphs. An interface to study [cell cycle](doc/circle.md) is currently being tested.